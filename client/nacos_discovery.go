...
import (
	...
	"github.com/xpsuper/rpcx/log"
	"github.com/xpsuper/rpcx/util"
)
...
func NewNacosDiscovery(servicePath, cluster, group string, clientConfig constant.ClientConfig, serverConfig []constant.ServerConfig) (ServiceDiscovery, error) {
	d := &NacosDiscovery{
...
func NewNacosDiscoveryWithClient(servicePath, cluster, group string, namingClient naming_client.INamingClient) ServiceDiscovery {
	d := &NacosDiscovery{
		servicePath: servicePath,
		Cluster:     cluster,
		Group:       group,
